...
const dict = {
  zh: {
    ...
    "transcribe.vadHelp.title": "VAD 设置参数说明",
    "transcribe.vadHelp.intro": "VAD（语音活动检测）在识别前将音频切分为语音段，以下参数影响切分行为。",
    "transcribe.vadHelp.default": "默认",
    "transcribe.vadHelp.seconds": "秒",
    "transcribe.vadHelp.threshold": "判定为语音的概率门槛。调低更易检出轻微或带噪声的语音（误判增多），调高只保留清晰语音（可能漏检）。",
    "transcribe.vadHelp.minSilence": "静音持续超过该时长才切分分段。调大可避免语气停顿把句子切碎，调小切分更细。",
    "transcribe.vadHelp.minSpeech": "短于该时长的语音片段会被丢弃，用于过滤噪声脉冲。",
    "transcribe.vadHelp.maxSpeech": "单个分段的最大长度，超过后强制切分。需保持在模型可处理的单段长度内。",
    "transcribe.vadHelp.threads": "VAD 计算使用的线程数，增大可加快检测速度。",
    "transcribe.vadHelp.close": "关闭",
    "transcribe.rtf": "RTF",
    ...
    // Subtitle page
    "subtitle.title": "转字幕",
    "subtitle.desc": "选择一个或多个音视频文件，批量生成 SRT 字幕文件到源文件所在文件夹",
    "subtitle.clickOrDrag": "点击选择或拖拽文件到此处",
    "subtitle.dropFiles": "松开以添加文件",
    "subtitle.selectFiles": "选择文件",
    "subtitle.addMore": "添加文件",
    "subtitle.start": "开始转字幕",
    "subtitle.stop": "停止",
    "subtitle.clear": "清除",
    "subtitle.remove": "移除",
    "subtitle.loadingModels": "正在加载模型...",
    "subtitle.initFailed": "模型加载失败",
    "subtitle.fileCount": "{count} 个文件",
    "subtitle.file": "文件",
    "subtitle.status": "状态",
    "subtitle.completedToast": "字幕生成完成 · 成功 {succeeded} 个 · 失败 {failed} 个 · 耗时 {time}s",
    "subtitle.noFiles": "请先选择音视频文件",
    "subtitle.pending": "等待中",
    "subtitle.processing": "转录中 {percent}%",
    "subtitle.writing": "写入字幕...",
    "subtitle.done": "已生成",
    "subtitle.failed": "失败",
    "subtitle.cancelled": "已停止",

    // Audio convert page
    "audioConvert.title": "转音频",
    "audioConvert.desc": "选择一个或多个视频文件，批量提取音频并转换为选定格式，保存到源文件所在文件夹",
    "audioConvert.formatLabel": "音频格式",
    "audioConvert.clickOrDrag": "点击选择或拖拽视频文件到此处",
    "audioConvert.dropFiles": "松开以添加文件",
    "audioConvert.selectFiles": "选择文件",
    "audioConvert.addMore": "添加文件",
    "audioConvert.start": "转音频",
    "audioConvert.stop": "停止",
    "audioConvert.clear": "清除",
    "audioConvert.remove": "移除",
    "audioConvert.fileCount": "{count} 个文件",
    "audioConvert.file": "文件",
    "audioConvert.status": "状态",
    "audioConvert.completedToast": "音频转换完成 · 成功 {succeeded} 个 · 失败 {failed} 个 · 耗时 {time}s",
    "audioConvert.noFiles": "请先选择视频文件",
    "audioConvert.pending": "等待中",
    "audioConvert.processing": "转换中 {percent}%",
    "audioConvert.processingIndeterminate": "转换中...",
    "audioConvert.done": "已转换",
    "audioConvert.failed": "失败",
    "audioConvert.cancelled": "已停止",
    "audioConvert.checkingFfmpeg": "正在检测 FFmpeg...",
    "audioConvert.ffmpegMissing": "未检测到 FFmpeg，转音频功能需要 FFmpeg",
    ...
    "settings.closeToExit": "退出应用",
    "settings.closeBehaviorHint": "点击窗口右上角关闭按钮时的行为",
  ...
  en: {
    ...
    "header.audio-convert": "Audio Convert",
    ...
    "transcribe.vadHelp.title": "VAD Settings Help",
    "transcribe.vadHelp.intro": "VAD (Voice Activity Detection) splits audio into speech segments before recognition. These parameters control the segmentation.",
    "transcribe.vadHelp.default": "default",
    "transcribe.vadHelp.seconds": "seconds",
    "transcribe.vadHelp.threshold": "Probability threshold for classifying audio as speech. Lower values detect faint or noisy speech (with more false positives); higher values keep only clear speech (may miss audio).",
    "transcribe.vadHelp.minSilence": "Silence must last this long before a segment is split. Increase to avoid splitting at brief pauses; decrease for finer segmentation.",
    "transcribe.vadHelp.minSpeech": "Speech shorter than this is discarded, filtering out noise pulses.",
    "transcribe.vadHelp.maxSpeech": "Maximum length of a single segment; longer speech is force-split. Keep within the model's per-segment limit.",
    "transcribe.vadHelp.threads": "Compute threads used by the VAD. Increase for faster detection.",
    "transcribe.vadHelp.close": "Close",
    "transcribe.rtf": "RTF",
    ...
    "subtitle.desc": "Select one or more audio/video files and generate SRT subtitle files next to the sources",
    "subtitle.clickOrDrag": "Click to select or drag files here",
    "subtitle.dropFiles": "Drop files to add",
    "subtitle.selectFiles": "Select Files",
    "subtitle.addMore": "Add Files",
    "subtitle.start": "Start Subtitles",
    "subtitle.stop": "Stop",
    "subtitle.clear": "Clear",
    "subtitle.remove": "Remove",
    "subtitle.loadingModels": "Loading models...",
    "subtitle.initFailed": "Model initialization failed",
    "subtitle.fileCount": "{count} file(s)",
    "subtitle.file": "File",
    "subtitle.status": "Status",
    "subtitle.completedToast": "Subtitles complete · {succeeded} succeeded · {failed} failed · {time}s",
    "subtitle.noFiles": "Please select audio/video files first",
    "subtitle.pending": "Pending",
    "subtitle.processing": "Transcribing {percent}%",
    "subtitle.writing": "Writing subtitle...",
    "subtitle.done": "Generated",
    "subtitle.failed": "Failed",
    "subtitle.cancelled": "Stopped",

    // Audio convert page
    "audioConvert.title": "Audio Convert",
    "audioConvert.desc": "Select one or more video files and batch extract audio into the chosen format, saved next to the sources",
    "audioConvert.formatLabel": "Audio format",
    "audioConvert.clickOrDrag": "Click to select or drag video files here",
    "audioConvert.dropFiles": "Drop files to add",
    "audioConvert.selectFiles": "Select Files",
    "audioConvert.addMore": "Add Files",
    "audioConvert.start": "Convert to Audio",
    "audioConvert.stop": "Stop",
    "audioConvert.clear": "Clear",
    "audioConvert.remove": "Remove",
    "audioConvert.fileCount": "{count} file(s)",
    "audioConvert.file": "File",
    "audioConvert.status": "Status",
    "audioConvert.completedToast": "Audio conversion complete · {succeeded} succeeded · {failed} failed · {time}s",
    "audioConvert.noFiles": "Please select video files first",
    "audioConvert.pending": "Pending",
    "audioConvert.processing": "Converting {percent}%",
    "audioConvert.processingIndeterminate": "Converting...",
    "audioConvert.done": "Converted",
    "audioConvert.failed": "Failed",
    "audioConvert.cancelled": "Stopped",
    "audioConvert.checkingFfmpeg": "Checking FFmpeg...",
    "audioConvert.ffmpegMissing": "FFmpeg not detected. Audio conversion requires FFmpeg.",
    ...
    "settings.closeToExit": "Exit application",
    "settings.closeBehaviorHint": "What happens when clicking the window close button",
